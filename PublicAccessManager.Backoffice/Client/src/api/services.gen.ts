...
export class DocumentService {
    ...
    public static deleteUmbracoManagementApiV1DocumentPublicAccessByIdDefaultPages<ThrowOnError extends boolean = false>(options: Options<DeleteUmbracoManagementApiV1DocumentPublicAccessByIdDefaultPagesData, ThrowOnError>) {
        return (options?.client ?? client).delete<DeleteUmbracoManagementApiV1DocumentPublicAccessByIdDefaultPagesResponse, DeleteUmbracoManagementApiV1DocumentPublicAccessByIdDefaultPagesError, ThrowOnError>({
            ...options,
            url: '/umbraco/management/api/v1/document/public-access/{id}/defaultPages'
        });
    }
    
    public static postUmbracoManagementApiV1DocumentPublicAccessDefaultPages<ThrowOnError extends boolean = false>(options?: Options<PostUmbracoManagementApiV1DocumentPublicAccessDefaultPagesData, ThrowOnError>) {
        return (options?.client ?? client).post<PostUmbracoManagementApiV1DocumentPublicAccessDefaultPagesResponse, PostUmbracoManagementApiV1DocumentPublicAccessDefaultPagesError, ThrowOnError>({
            ...options,
    ...
    public static putUmbracoManagementApiV1DocumentPublicAccessDefaultPages<ThrowOnError extends boolean = false>(options?: Options<PutUmbracoManagementApiV1DocumentPublicAccessDefaultPagesData, ThrowOnError>) {
        return (options?.client ?? client).put<PutUmbracoManagementApiV1DocumentPublicAccessDefaultPagesResponse, PutUmbracoManagementApiV1DocumentPublicAccessDefaultPagesError, ThrowOnError>({
            ...options,
            url: '/umbraco/management/api/v1/document/public-access/defaultPages'
        });
    }
