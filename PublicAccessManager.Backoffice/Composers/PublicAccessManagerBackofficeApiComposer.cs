...
namespace PublicAccessManager.Backoffice.Composers
{
    public class PublicAccessManagerBackofficeApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Public Access Manager Backoffice Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<PublicAccessManagerBackofficeOperationSecurityFilter>();
            });
        }

        public class
            PublicAccessManagerBackofficeOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
                ...
                ControllerActionDescriptor controllerActionDescriptor)
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith(
                    "PublicAccessManager.Backoffice.Controllers",
